...
const Login = (props) => {
  ...
  const emailChangeHandler = (event) => {
    dispachEmail({type: 'EMAIL_USER_INPUT', val: event.target.value});
  ...
  const passwordChangeHandler = (event) => {
    dispachPassword({type: 'PASSWORD_USER_INPUT', val: event.target.value});
  ...
  const validateEmailHandler = () => {
    dispachEmail({type: 'EMAIL_BLUR_INPUT'});
  };

  const validatePasswordHandler = () => {
    dispachPassword({type: 'PASSWORD_BLUR_INPUT'});
  };
